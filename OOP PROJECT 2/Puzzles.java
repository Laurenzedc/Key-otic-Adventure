...
public class Puzzles {
    ...
    public static class Puzzle {
            ...
            switch (hero.getType()) {
                ...
                case KAYA -> {
                    if (natureRelated || kind == PuzzleKind.DECISION) {
                        ...
                        System.out.println("“The gentle path avoids extremes.”\n");
                    }
                    return false;
                }
            }
        ...
        public boolean play(Game game) {
            ...
            if (hero.canUseAbility()) {
                ...
                if (game.readLine().trim().toLowerCase().startsWith("y")) {
            ...
            // NEW — Apply damage reduction from item
    ...
    public static List<Puzzle> level2Puzzles() {
        ...
        list.add(new Puzzle(
                8, "Bottle Cipher",
                "Bottles spell: F L I E A. Unscramble the word.",
                "Type the word:",
                "Correct.",
                "Wrong.",
